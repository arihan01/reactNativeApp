...
const FTSavedStack = createNativeStackNavigator();
...
const FTSavedScreen = ({navigation}) => {
    return(
        <FTSavedStack.Navigator screenOptions={{
            headerStyle: {
            ...
            <FTSavedStack.Screen name="FTSaved" component={FTSaved} options={{title:"Saved Field Tickets", 
                headerLeft: () => (
                ...
                />
            <FTSavedStack.Screen name="NewFT" component={NewFTScreens} options={{title:"Create New FT"}}/>
        </FTSavedStack.Navigator> 
    )
}

export default FTSavedScreen
