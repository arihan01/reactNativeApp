...
const SoftwareScheduleScreen = ({navigation}) => {
    return (
        <SoftwareStack.Navigator screenOptions={{
            ...
            <SoftwareStack.Screen name="SoftwareSched" component={Software} options={{title:"Schedule", 
                headerLeft: () => (
...
export default SoftwareScheduleScreen