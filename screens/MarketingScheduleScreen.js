...
const MarketingScheduleScreen = ({navigation}) => {
    return (
        <MarketingStack.Navigator screenOptions={{
            ...
            <MarketingStack.Screen name="MarketingSched" component={Marketing} options={{title:"Schedule", 
                headerLeft: () => (
...
export default MarketingScheduleScreen